...
FreeJ  is a  multi-threaded  engine that  runs  efficiently on  modern
multi-core computers,  where 
...
[[file:http://freej.dyne.org/pics/freej_at_piksel2005.jpg][The FreeJ team at Piksel 2005 in Norway, from left to right: Kysucix, Mr.Goil and Jaromil]]
...
graphical interface (Carbon/Cocoa)  that shows functionalities. We are
looking  for designers  to help  make  it look  better! meanwhile  the
sourcecode in the *osx/* directory is good starting point to build GNU
free applications on this platform.

BLAG GNU/Linux
RPM packages available to install
direct download urls for i386 and 64bit
...
course  an "Hello  World" example  is there.  Here you  find  also the
[[http://freej.dyne.org/docs/scripting][scripting API reference]].
