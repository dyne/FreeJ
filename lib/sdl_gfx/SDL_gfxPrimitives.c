...
int _filledRectAlpha(SDL_Surface * surface, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color, Uint8 alpha)
{
    ...
    } else if(surface->format->BytesPerPixel == 2) { /* Probably 15-bpp or 16-bpp */
      Uint16 *row, *pixel;
    ...
    } else if(surface->format->BytesPerPixel == 3) { /* Slow 24-bpp mode, usually not used */
      Uint8 *row, *pix;
      Uint8 dR, dG, dB, dA;
      Uint8 rshift8 = surface->format->Rshift / 8;
      Uint8 gshift8 = surface->format->Gshift / 8;
    ...
    } else if(surface->format->BytesPerPixel == 4) { /* Probably 32-bpp */
      Uint32 *row, *pixel;
      Uint32 dR = (color & Rmask), dG = (color & Gmask), dB = (color & Bmask), dA = (color & Amask);
