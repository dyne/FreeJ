...
#define FFMPEG_CONFIGURATION " --disable-strip --disable-opts --enable-vorbis --enable-xvid --enable-shared --enable-gpl --enable-mp3lame --enable-vorbis --enable-libogg --enable-pthreads --enable-shared-pp --enable-pp --cpu=pentium4 --tune=pentium4 --enable-memalign-hack --enable-dts --enable-faad --enable-faadbin --enable-faac --enable-theora "
